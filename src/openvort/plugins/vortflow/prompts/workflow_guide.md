...
6. **设计完成 (design_done)** — 设计阶段结束，等待进入研发准备
7. **拆分估时 (breakdown)** — 将需求拆分为子任务，估算工时
8. **分配开发 (dev_assign)** — 分配前端/后端/全栈开发人员
9. **开发中 (in_progress)** — 开发进行中
10. **测试中 (testing)** — 提测，测试人员验证
11. **Bug 修复 (bugfix)** — 发现 Bug 后修复，修复后回归测试
12. **完成 (done)** — 测试通过，需求交付
