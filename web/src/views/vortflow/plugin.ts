    ...
    routes: [
        {
            ...
            children: [
                ...
                { path: "test-reports/:id", name: "vortflow-test-report-detail", component: () => import("./TestReportDetail.vue"), meta: { title: "测试报告详情" } },
    ...
    menus: [
        {
            ...
            children: [
                ...
                { title: "测试用例", icon: "clipboard-check", path: "/vortflow/test-cases" },
                { title: "测试计划", icon: "list-todo", path: "/vortflow/test-plans" },
