...
export const menuConfig: MenuConfig[] = [
    ...
    { title: "Webhook", icon: "webhook", path: "/webhooks", requiredRole: "admin" },
    { title: "Agent 路由", icon: "git-branch", path: "/agents", requiredRole: "admin" },
    { title: "模型管理", icon: "cpu", path: "/models", requiredRole: "admin" },
