...
│   └── views/               # login/chat/workspace/dashboard/profile + admin 页面
├── package.json
└── vite.config.ts
```
...
路由：login / chat(SSE流式) / workspace / dashboard / schedules / profile + admin(contacts/plugins/channels/skills/logs/settings)
